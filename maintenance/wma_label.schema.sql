...
--
-- Dumping data for table `wma_label`
--

LOCK TABLES `wma_label` WRITE;
/*!40000 ALTER TABLE `wma_label` DISABLE KEYS */;
/*!40000 ALTER TABLE `wma_label` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2011-03-23 15:39:38
